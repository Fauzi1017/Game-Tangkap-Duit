    ...
    (function() {
      ...
      z2("Promise", function(a) {
        ...
        b.prototype.T = function(f, h) {
          ...
          var l = this;
          null == this.h ? g.i(k2) : this.h.push(k2);
          this.u = true;
        };
        b.resolve = d;
        b.reject = function(f) {
        ...
        b.race = function(f) {
          return new b(function(h, k2) {
            for (var l = A2(f), m = l.next(); !m.done; m = l.next()) d(m.value).T(h, k2);
          });
        };
        b.all = function(f) {
          var h = A2(f), k2 = h.next();
          return k2.done ? d([]) : new b(function(l, m) {
            ...
            var p = [], n = 0;
            do
              p.push(void 0), n++, d(k2.value).T(r(p.length - 1), m), k2 = h.next();
            while (!k2.done);
          });
        };
        return b;
      ...
      function Wa(a) {
        ...
        else if (Ua) a = BigInt(a), G2 = Number(a & BigInt(4294967295)) >>> 0, H2 = Number(a >> BigInt(32) & BigInt(4294967295));
        else {
          var b = +("-" === a[0]);
          H2 = G2 = 0;
          for (var c = a.length, d = b, e = (c - b) % 6 + b; e <= c; d = e, e += 6) d = Number(a.slice(d, e)), H2 *= 1e6, G2 = 1e6 * G2 + d, 4294967296 <= G2 && (H2 += G2 / 4294967296 | 0, G2 %= 4294967296);
          b && (b = A2(Ta(G2, H2)), a = b.next().value, b = b.next().value, G2 = a, H2 = b);
        }
        return new Va(G2, H2);
      }
      var Xa;
      ...
      function zb(a, b) {
        O2 ? a[O2] && (a[O2] &= ~b) : void 0 !== a.A && (a.A &= ~b);
      }
      function Q2(a) {
        var b;
        O2 ? b = a[O2] : b = a.A;
      ...
      function R2(a, b) {
        O2 ? a[O2] = b : void 0 !== a.A ? a.A = b : Object.defineProperties(a, { A: { value: b, configurable: true, writable: true, enumerable: false } });
      }
      function Ab(a) {
        P2(a, 1);
        return a;
      ...
      function Lb(a, b, c, d) {
        ...
        var g = Q2(e);
        g & 1 || Ab(e);
        if (d) g & 2 || P2(e, 2), c & 1 || Object.freeze(e);
        else {
          d = !(c & 2);
          var f = g & 2;
      ...
      function Nb(a, b, c, d, e) {
        ...
        if (!g) {
          ...
          b = k2 | 33;
          b = m ? b & -9 : b | 8;
          k2 != b && (m = h, Object.isFrozen(m) && (m = Array.prototype.slice.call(m)), R2(m, b), h = m);
          l !== h && Kb(
            a,
            c,
            h
      ...
      function Pb(a, b) {
        ...
        if (e) for (var k2 in e) $b(a, d, +k2, e[k2], true, g, b);
        return d;
      }
      ;
      function X2(a, b, c) {
        ...
        if (c) {
          ...
          e = this.i;
          var n;
          for (k2 = 0; k2 < c.length; k2++) f = c[k2], f < e ? (f += this.G, (d = a[f]) ? ac(d, b) : a[f] = Fb) : (n || (n = Jb(this)), (d = n[f]) ? ac(d, b) : n[f] = Fb);
        }
      }
      ...
      function oc(a, b, c, d, e, g) {
        ...
        for (; f < a.length; ) {
          c = a[f++];
          for (var k2 = f + 1; k2 < a.length && "number" !== typeof a[k2]; ) k2++;
          h = a[f++];
          k2 -= f;
          switch (k2) {
            case 0:
              ...
              break;
            case 1:
              (k2 = lc(a, f)) ? (f++, e(b, c, h, k2)) : d(b, c, h, a[f++]);
              break;
            case 2:
              k2 = f++;
              k2 = lc(a, k2);
      ...
      function uc(a, b, c, d) {
        ...
        a.push(b, function(h, k2, l) {
          return f(h, k2, l, g, e);
        });
      }
      function vc(a, b, c, d, e, g) {
        var f = dc(d, g), h = c.W;
        a.push(b, function(k2, l, m) {
          return h(k2, l, m, d, f);
        });
      }
      function qc(a) {
      ...
      function yc(a, b, c, d, e) {
        ...
        a[b] = function(k2, l, m) {
          return g(k2, l, m, h, f, e);
        };
      }
      function zc(a, b, c, d, e, g, f) {
        var h = c.U, k2 = fc(d, e, g);
        a[b] = function(l, m, r) {
          return h(l, m, r, d, k2, f);
        };
      }
      function hc(a) {
        var b = a[mc];
      ...
      var Y2 = Ac(function(a, b, c) {
        ...
        g = f >>> 23 & 255;
        f &= 8388607;
        U2(b, c, 255 == g ? f ? NaN : Infinity * a : 0 == g ? a * Math.pow(2, -149) * f : a * Math.pow(2, g - 150) * (f + Math.pow(2, 23)));
        return true;
      }, function(a, b, c) {
        b = Mb(b, c);
        if (null != b) {
          ...
          a = a.h;
          var d = +b;
          0 === d ? 0 < 1 / d ? G2 = H2 = 0 : (H2 = 0, G2 = 2147483648) : isNaN(d) ? (H2 = 0, G2 = 2147483647) : (d = (c = 0 > d ? -2147483648 : 0) ? -d : d, 34028234663852886e22 < d ? (H2 = 0, G2 = (c | 2139095040) >>> 0) : 11754943508222875e-54 > d ? (d = Math.round(d / Math.pow(2, -149)), H2 = 0, G2 = (c | d) >>> 0) : (b = Math.floor(Math.log(d) / Math.LN2), d *= Math.pow(2, -b), d = Math.round(8388608 * d), 16777216 <= d && ++b, H2 = 0, G2 = (c | b + 127 << 23 | d & 8388607) >>> 0));
          c = G2;
          a.h.push(c >>> 0 & 255);
          a.h.push(c >>> 8 & 255);
          a.h.push(c >>> 16 & 255);
        ...
        32 < g && (a |= (k2 & 127) >> 4);
        for (g = 3; 32 > g && k2 & 128; g += 7) k2 = f[h++], a |= (k2 & 127) << g;
        L2(
          d,
          h
        );
        if (128 > k2) {
          d = e >>> 0;
          k2 = a >>> 0;
          if (a = k2 & 2147483648) d = ~d + 1 >>> 0, k2 = ~k2 >>> 0, 0 == d && (k2 = k2 + 1 >>> 0);
          d = 4294967296 * k2 + (d >>> 0);
        } else throw Za();
        U2(b, c, a ? -d : d);
        return true;
        ...
        b = S2(b, c);
        null != b && ("string" === typeof b && Wa(b), null != b && (M(a.h, 8 * c), "number" === typeof b ? (a = a.h, Sa(b), sb(a, G2, H2)) : (c = Wa(b), sb(a.h, c.i, c.h))));
        ...
        if (db) {
          ...
          d = h + d;
          e = [];
          for (var k2 = null, l, m; h < d; ) l = a[h++], 128 > l ? e.push(l) : 224 > l ? h >= d ? K2() : (m = a[h++], 194 > l || 128 !== (m & 192) ? (h--, K2()) : e.push((l & 31) << 6 | m & 63)) : 240 > l ? h >= d - 1 ? K2() : (m = a[h++], 128 !== (m & 192) || 224 === l && 160 > m || 237 === l && 160 <= m || 128 !== ((g = a[h++]) & 192) ? (h--, K2()) : e.push((l & 15) << 12 | (m & 63) << 6 | g & 63)) : 244 >= l ? h >= d - 2 ? K2() : (m = a[h++], 128 !== (m & 192) || 0 !== (l << 28) + (m - 144) >> 30 || 128 !== ((g = a[h++]) & 192) || 128 !== ((f = a[h++]) & 192) ? (h--, K2()) : (l = (l & 7) << 18 | (m & 63) << 12 | (g & 63) << 6 | f & 63, l -= 65536, e.push((l >> 10 & 1023) + 55296, (l & 1023) + 56320))) : K2(), 8192 <= e.length && (k2 = ab(k2, e), e.length = 0);
          h = ab(k2, e);
        }
        U2(b, c, h);
        return true;
      ...
      function Uc(a) {
        return Ob(a, Z2, 1).map(function(b) {
          var c = S2(b, 1);
          return { index: null == c ? 0 : c, score: W2(b, 2), label: null != S2(b, 3) ? Rb(S2(b, 3), "") : void 0, displayName: null != S2(b, 4) ? Rb(S2(b, 4), "") : void 0 };
        });
      }
      ;
      function Vc(a) {
      ...
      function gd(a) {
        var b, c, d, e, g, f, h, k2, l, m, r;
        return E2(function(p) {
          switch (p.h) {
            case 1:
      ...
      function id(a) {
        var b, c, d, e, g, f, h, k2;
        return E2(function(l) {
          if (1 == l.h) {
          ...
          a.D = {};
          if (a.h.listeners) for (g = A2(a.h.listeners), f = g.next(); !f.done; f = g.next()) h = f.value, jd(a, h);
          k2 = a.l;
          a.l = {};
          a.setOptions(k2);
          l.h = 0;
      ...
      x.setOptions = function(a, b) {
        ...
        if (b = b || this.h.options) {
          for (var d = [], e = [], g = {}, f = A2(Object.keys(a)), h = f.next(); !h.done; g = { X: g.X, Y: g.Y }, h = f.next()) if (h = h.value, !(h in this.l && this.l[h] === a[h])) {
            this.l[h] = a[h];
            var k2 = b[h];
            void 0 !== k2 && (k2.onChange && (g.X = k2.onChange, g.Y = a[h], d.push(/* @__PURE__ */ (function(l) {
              return function() {
                var m;
                return E2(function(r) {
            ...
            })(g))), k2.graphOptionXref && (h = Object.assign(
              {},
              { calculatorName: "", calculatorIndex: 0 },
              k2.graphOptionXref,
              { valueNumber: 1 === k2.type ? a[h] : 0, valueBoolean: 0 === k2.type ? a[h] : false, valueString: 2 === k2.type ? a[h] : "" }
            ), e.push(h)));
          }
        ...
        return E2(function(p) {
          switch (p.h) {
            ...
            case 3:
              ...
              g = A2(Object.keys(a));
              for (f = g.next(); !f.done; f = g.next()) if (h = f.value, k2 = c.h.inputs[h]) {
                a: {
                  var n = a[h];
                  switch (k2.type) {
                    case "video":
                      var q2 = c.s[k2.stream];
                      q2 || (q2 = new Xc(c.i, c.K), c.s[k2.stream] = q2);
                    ...
                    case "detections":
                      q2 = c.s[k2.stream];
                      q2 || (q2 = new $c(c.i), c.s[k2.stream] = q2);
                      ...
                      for (w = 0; w < n.length; ++w) {
                        ...
                        if (t2.ba) for (v = 0; v < t2.ba.length; ++v) B2 = q2.data, J2 = B2.addClassification, I2 = w, u = t2.ba[v], C2 = new Z2(), V2(C2, 2, u.score), u.index && U2(C2, 1, u.index), u.label && U2(C2, 3, u.label), u.displayName && U2(C2, 4, u.displayName), u = C2.l(), J2.call(B2, I2, u);
                      }
                      q2 = q2.data;
                      break a;
                    default:
      ...
      function ld(a, b, c) {
        var d, e, g, f, h, k2, l, m, r, p, n, q2, t2, w;
        return E2(function(v) {
          switch (v.h) {
            case 1:
              ...
              e = 0;
              g = A2(Object.keys(c));
              for (f = g.next(); !f.done; f = g.next()) h = f.value, k2 = c[h], "string" !== typeof k2 && "texture" === k2.type && void 0 !== b[k2.stream] && ++e;
              1 < e && (a.M = false);
              l = A2(Object.keys(c));
              f = l.next();
            case 2:
              ...
              if ("detection_list" === r.type) {
                if (p) {
                  ...
                  for (var J2 = p.getLandmarksList(), I2 = p.getClassificationsList(), u = [], C2 = 0; C2 < B2.size(); ++C2) {
      ...
      function jd(a, b) {
        for (var c = b.name || "$", d = [].concat(ea(b.wants)), e = new a.i.StringList(), g = A2(b.wants), f = g.next(); !f.done; f = g.next()) e.push_back(f.value);
        g = a.i.PacketListener.implement({ onResults: function(h) {
          for (var k2 = {}, l = 0; l < b.wants.length; ++l) k2[d[l]] = h.get(l);
          var m = a.listeners[c];
          m && (a.I = ld(a, k2, b.outs).then(function(r) {
            r = m(r);
      ...
      function od(a) {
        ...
        this.h = new fd({ locateFile: a.locateFile, files: function(c) {
          ...
          onChange: function(c) {
            var d, e, g;
            return E2(function(f) {
              if (1 == f.h) return d = nd(c), e = "third_party/mediapipe/modules/hand_landmark/" + d, D2(f, hd(b.h, d), 2);
              g = f.i;
  ...
  function h(h2) {
    return function(s) {
      return (function(h3) {
        ...
        for (; o && (o = 0, h3[0] && (a = 0)), a; ) try {
          if (n = 1, i && (r = 2 & h3[0] ? i.return : h3[0] ? i.throw || ((r = i.return) && r.call(i), 0) : i.next) && !(r = r.call(i, h3[1])).done) return r;
          switch (i = 0, r && (h3 = [2 & h3[0], r.value]), h3[0]) {
            case 0:
            case 1:
              r = h3;
              break;
            case 4:
              return a.label++, { value: h3[1], done: false };
            case 5:
              a.label++, i = h3[1], h3 = [0];
              continue;
            case 7:
              h3 = a.ops.pop(), a.trys.pop();
              continue;
            default:
              if (!(r = a.trys, (r = r.length > 0 && r[r.length - 1]) || 6 !== h3[0] && 2 !== h3[0])) {
                a = 0;
                continue;
              }
              if (3 === h3[0] && (!r || h3[1] > r[0] && h3[1] < r[3])) {
                a.label = h3[1];
                break;
              }
              if (6 === h3[0] && a.label < r[1]) {
                a.label = r[1], r = h3;
                break;
              }
              if (r && a.label < r[2]) {
                a.label = r[2], a.ops.push(h3);
                break;
              }
        ...
        if (5 & h3[0]) throw h3[1];
        return { value: h3[0] ? h3[1] : void 0, done: true };
      })([h2, s]);
    };
  }
}
...
var k = (function() {
  function i(e) {
    var n, i2 = this;
    if (this.width = 0, this.height = 0, this.selfieMode = false, this.handsSolution = new import_hands.Hands({ locateFile: function(t2, n2) {
      return e.solutionPath ? e.solutionPath.replace(/\/+$/, "") + "/" + t2 : n2 + "/" + t2;
    } }), "lite" === e.modelType) n = 0;
    else n = 1;
    this.handsSolution.setOptions({ modelComplexity: n, selfieMode: this.selfieMode, maxNumHands: e.maxHands }), this.handsSolution.onResults((function(t2) {
      if (i2.height = t2.image.height, i2.width = t2.image.width, i2.hands = [], null !== t2.multiHandLandmarks) for (var e2 = t2.multiHandedness, n2 = t2.multiHandLandmarks, r = t2.multiHandWorldLandmarks, o = 0; o < e2.length; o++) i2.hands.push(I(I({}, i2.translateOutput(n2[o], r[o])), { score: e2[o].score, handedness: e2[o].label }));
    }));
  }
...
function V(t2, e) {
  var n = (function(t3, e2, n2, i) {
    var r = e2 - t3, o = i - n2;
    if (0 === r) throw new Error("Original min and max are both " + t3 + ", range cannot be 0.");
    var a = o / r;
...
function P(t2, e, n) {
  var i = e.outputTensorSize, o = e.keepAspectRatio, a = e.borderMode, d = e.outputTensorFloatRange, c = N(t2), f = (function(t3, e2) {
  ...
  })(f, i, o), m = E(f, c.width, c.height, false), g = tidy((function() {
...
function Y(t2, e, n, i, r) {
  var o = "rect" === n ? (function(t3, e2, n2) {
    ...
    if ("boundingbox" === e2) i2 = K(r2.boundingBox);
    else {
      i2 = F(r2);
        ...
        case 0:
          return i = t2[0], h = t2[1], s = (function(t3, e2, n2) {
            return tidy((function() {
              ...
              if (n2.numKeypoints) for (var w = 0; w < n2.numKeypoints; ++w) {
                var b = n2.keypointCoordOffset + w * n2.numValuesPerKeypoint, I2 = void 0, S2 = void 0;
                n2.reverseOutputOrder ? (I2 = squeeze(slice(t3, [0, b], [-1, 1])), S2 = squeeze(slice(t3, [0, b + 1], [-1, 1]))) : (S2 = squeeze(slice(t3, [0, b], [-1, 1])), I2 = squeeze(slice(t3, [0, b + 1], [-1, 1])));
                var T2 = add(mul(div(I2, n2.xScale), e2.w), e2.x), _2 = add(mul(div(S2, n2.yScale), e2.h), e2.y);
                M = concat([M, reshape(T2, [n2.numBoxes, 1]), reshape(_2, [n2.numBoxes, 1])], 1);
              }
              return M;
            }));
  ...
  return S(this, void 0, void 0, (function() {
    ...
    return T(this, (function(m) {
      switch (m.label) {
        ...
        case 2:
          for (o = m.sent(), a = 0; a < n.numBoxes; ++a) if (!(null != n.minScoreThresh && o[a] < n.minScoreThresh || (h = a * n.numCoords, s = G(r[h + 0], r[h + 1], r[h + 2], r[h + 3], o[a], n.flipVertically, a), (u = s.locationData.relativeBoundingBox).width < 0 || u.height < 0))) {
            if (n.numKeypoints > 0) for ((l = s.locationData).relativeKeypoints = [], d = n.numKeypoints * n.numValuesPerKeypoint, c = 0; c < d; c += n.numValuesPerKeypoint) f = h + n.keypointCoordOffset + c, p = { x: r[f + 0], y: n.flipVertically ? 1 - r[f + 1] : r[f + 1] }, l.relativeKeypoints.push(p);
            i.push(s);
          }
          return [2, i];
      }
  ...
  return S(this, void 0, void 0, (function() {
    ...
    return T(this, (function(c) {
      switch (c.label) {
        ...
        case 1:
          for (a = c.sent(), h = [], s = 0; s < e.numLandmarks; ++s) u = s * o, (d = { x: 0, y: 0 }).x = n ? e.inputImageWidth - a[u] : a[u], o > 1 && (d.y = i ? e.inputImageHeight - a[u + 1] : a[u + 1]), o > 2 && (d.z = a[u + 2]), o > 3 && (d.score = Z(e.visibilityActivation, a[u + 3])), h.push(d);
          for (l = 0; l < h.length; ++l) (d = h[l]).x = d.x / e.inputImageWidth, d.y = d.y / e.inputImageHeight, d.z = d.z / e.inputImageWidth / (e.normalizeZ || 1);
          return [2, h];
      }
    }));
  }));
...
function Q(t2, e) {
  ...
  var w = (o + r) / 2, b = (h + a) / 2, I2 = w * Math.cos(n) - b * Math.sin(n) + e.width * c, S2 = w * Math.sin(n) + b * Math.cos(n) + e.height * f, T2 = (o - r) / e.width, _2 = (h - a) / e.height;
  return { xCenter: I2 / e.width, yCenter: S2 / e.height, width: T2, height: _2, rotation: n };
}
...
var ct = (function() {
    ...
    this.detectorModel = t3, this.landmarkModel = e, this.maxHands = n, this.prevHandRectsFromLandmarks = null, this.anchors = (function(t4) {
      ...
      for (var e2 = [], n2 = 0; n2 < t4.numLayers; ) {
        for (var i2 = [], r2 = [], o2 = [], a2 = [], h = n2; h < t4.strides.length && t4.strides[h] === t4.strides[n2]; ) {
          ...
          if (0 === h && t4.reduceBoxesInLowestLayer) o2.push(1), o2.push(2), o2.push(0.5), a2.push(0.1), a2.push(s), a2.push(s);
          else {
            for (var u = 0; u < t4.aspectRatios.length; ++u) o2.push(t4.aspectRatios[u]), a2.push(s);
        ...
        var f = 0, p = 0;
        if (t4.featureMapHeight.length > 0) f = t4.featureMapHeight[n2], p = t4.featureMapWidth[n2];
        else {
          var m = t4.strides[n2];
          f = Math.ceil(t4.inputSizeHeight / m), p = Math.ceil(t4.inputSizeWidth / m);
        }
        for (var g = 0; g < f; ++g) for (var x = 0; x < p; ++x) for (var y = 0; y < i2.length; ++y) {
  ...
  return t2.prototype.estimateHands = function(t3, e) {
    return S(this, void 0, void 0, (function() {
      var n, i, o, a, h, d, f, p, m, g, x, y, v, M, w, b, S2, C2, k2 = this;
      return T(this, (function(T2) {
        switch (T2.label) {
          case 0:
            return n = (function(t4) {
              if (null == t4) return I({}, nt);
              var e2 = I({}, t4);
            ...
            })(e), null == t3 ? (this.reset(), [2, []]) : (i = N(t3), o = tidy((function() {
          ...
          case 1:
            return 0 === (d = T2.sent()).length ? (this.reset(), o.dispose(), [2, []]) : (f = d.map((function(t4) {
          ...
          case 4:
            for (p = T2.sent(), m = [], this.prevHandRectsFromLandmarks = [], g = 0, x = p; g < x.length; g++) null != (y = x[g]) && (v = y.landmarks, M = y.worldLandmarks, w = y.handScore, b = y.handedness, this.prevHandRectsFromLandmarks.push(this.handLandmarksToRoi(v, i)), null != (S2 = X(v, i)) && S2.forEach((function(t4, e2) {
              delete t4.z, t4.name = _[e2];
            })), null != (C2 = M) && C2.forEach((function(t4, e2) {
              t4.name = _[e2];
            })), m.push({ keypoints: S2, keypoints3D: C2, handedness: b, score: w }));
  ...
  return S(this, void 0, void 0, (function() {
    ...
    return T(this, (function(h) {
      switch (h.label) {
        case 0:
          return e = (function(t3) {
            if (null == t3) return I({}, et);
            var e2 = I({}, t3);
            if (e2.runtime = "tfjs", null == e2.maxHands && (e2.maxHands = et.maxHands), null == e2.modelType && (e2.modelType = et.modelType), "lite" !== e2.modelType && "full" !== e2.modelType) throw new Error("Model type must be one of lite or full, but got " + e2.modelType);
            null == e2.detectorModelUrl && ("lite" === e2.modelType ? e2.detectorModelUrl = "https://tfhub.dev/mediapipe/tfjs-model/handpose_3d/detector/lite/1" : e2.detectorModelUrl = "https://tfhub.dev/mediapipe/tfjs-model/handpose_3d/detector/full/1");
            null == e2.landmarkModelUrl && ("lite" === e2.modelType ? e2.landmarkModelUrl = "https://tfhub.dev/mediapipe/tfjs-model/handpose_3d/landmark/lite/1" : e2.landmarkModelUrl = "https://tfhub.dev/mediapipe/tfjs-model/handpose_3d/landmark/full/1");
            return e2;
...
function pt(t2, e) {
  return S(this, void 0, void 0, (function() {
    ...
    return T(this, (function(r) {
      if (t2 === dt.MediaPipeHands) {
        if (i = void 0, null != (n = e)) {
          if ("tfjs" === n.runtime) return [2, ft(n)];
          if ("mediapipe" === n.runtime) return [2, H(n)];
          i = n.runtime;
        }
...
@tensorflow-models/hand-pose-detection/dist/hand-pose-detection.esm.js:
  (**
      * @license
